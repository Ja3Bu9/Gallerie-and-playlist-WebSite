...
class LinkedList {
  constructor() {
    ...
    this.page = ['<img width="300px" src="img/red.jpg" alt=""><div class="infos"><div class="flex"><h1>Titre : </h1><h2> Red Square Meeting</h2></div><div class="flex"><h1>Artiste :</h1><h2>Trabant 33</h2></div></div>', '<img width="300px" src="img/hide.jpg" alt=""><div class="infos"><div class="flex"><h1>Titre : </h1><h2>Hide And Seek</h2></div><div class="flex"><h1>Artiste :</h1><h2>Mike Franklyn</h2></div></div>', '<img width="300px" src="img/sun.jpg" alt=""><div class="infos"><div class="flex"><h1>Titre : </h1><h2>Sunshine Stroll</h2></div><div class="flex"><h1>Artiste :</h1><h2>Mike Franklyn</h2></div></div>', '<img width="300px" src="img/up.jpg" alt=""><div class="infos"><div class="flex"><h1>Titre : </h1><h2>Up in Trouble</h2></div><div class="flex"><h1>Artiste :</h1><h2>Mike Franklyn</h2></div></div>'];
